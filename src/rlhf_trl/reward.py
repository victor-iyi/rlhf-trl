...
if __name__ == '__main__':
    ...
    prompt_text = ['The quick brown fox jumps over the lazy dog', 'The quick brown fox jumps over the lazy dog']
    response_text = ['The quick brown fox jumps over the lazy dog', 'The quick brown fox jumps over the lazy dog']
    device = 'cpu'
